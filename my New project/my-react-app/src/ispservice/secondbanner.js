                        ...
                        <div className='container row'>
                            <div className='col-md-5 bor' >
                                <div className=' contentsection'>
                                    ...
                                    <p className='bannercontentone' data-aos="fade-up" data-aos-duration="1000">Lightning-Fast Internet Awaits You</p>

                                </div>
                                <div className='lists'>
                                    <p className='bannercontentpara' data-aos="fade-up" data-aos-duration="1000">Experience blazing-fast internet with [Your ISP Name]. Say goodbye to buffering and lag – choose your speed, connect, and enjoy the future of connectivity.</p>
                                </div>
