                    ...
                    >
                        <div className='row' >
                            <div className='col-md-5 dashed' data-aos="fade-up" data-aos-duration="2000" >
                                ...
                                <div className='lists'>
                                    <p className='bannercontentpara'>Consult our experts for personalized plan options. Your connectivity needs, our expertise.</p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className='row Boxss'>
                                <div className="servicebox col-lg-4" data-aos="fade-right" data-aos-duration="2000">
                                    <div className="serviceContents">
                                        <div className='des-blog'><i className="fa fa-solid fa-phone phones" style={{ color: "#9cc723" }}></i></div>
                                        ...
                                        <div className='buttons'> <a href="tel:+1234567890" className='btns-greenbox link-without-underline'>Call now</a></div>
                                ...
                                <div className="servicebox col-lg-4" data-aos="fade-up" data-aos-duration="2000">
                                    <div className="serviceContents">
                                        <div className='des-blog'><i className="fa fa-solid fa-envelope" style={{ color: "#9bc91d" }}></i></div>
                                        ...
                                        <div className='buttons'> <a href="mailto:info@infygain.com" className='btns-greenbox link-without-underline'>mail now</a></div>
                                ...
                                <div className="servicebox col-lg-4" data-aos="fade-left" data-aos-duration="2000">
                                    <div className="serviceContents">
                                        ...
                                        <div className='buttons'> <a href="https://api.whatsapp.com/send?phone=9952141444" className='btns-greenbox link-without-underline'>chat now</a></div>
