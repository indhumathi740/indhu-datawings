                    ...
                    <div className='row formrow'>
                        ...
                        <div className=' container col-lg-6 rightsidecontents' data-aos="fade-left" >
                            <div className='row overall-con'>
                                ...
                                <div className='rigonebox' >
                                    <div className='col-md-2 icon-isp-about' >
                                        <img src="/images/banner/loc.png" alt="service icons" className='  fa-isp'title='Head office'></img>                                 </div>
                            ...
                            <div className='row second'>
                                <div className='rigonebox'>
                                    <div className='col-md-2 icon-isp-about'>
                                        <img src="/images/banner/Text.png" alt="service icons" className='  fa-isp'title='Email us'></img>                                </div>
                                    <div className='col-md-10 icon-isp-about-con'>
                            ...
                            <div className='row third'>
                                <div className='rigonebox'>
                                    <div className='col-md-2 icon-isp-about'>
                                        <img src="/images/banner/ph.png" alt="service icons" className='fa-isp'title='Contact us'></img>                                </div>
